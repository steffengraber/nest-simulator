...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    ({'interval': 0.1, 'use_gid_in_filename': True, 'precision': 3, 'events': {'rate': array([], dtype=float64), 'times': array([], dtype=float64)}, 'local_id': 3, 'element_type': <SLILiteral: recorder>, 'to_accumulator': False, 'withtargetgid': False, 'close_after_simulate': False, 'to_file': False, 'flush_records': False, 'origin': 0.0, 'label': '', 'withport': False, 'withgid': False, 'global_id': 3, 'to_screen': False, 'time_in_steps': False, 'frozen': False, 'withweight': False, 'record_to': (<SLILiteral: memory>,), 'fbuffer_size': -1, 'close_on_reset': True, 'vp': 0, 'binary': False, 'thread': 0, 'scientific': False, 'to_memory': True, 'node_uses_wfr': False, 'stop': 1.7976931348623157e+308, 'n_events': 0, 'model': <SLILiteral: multimeter>, 'parent': 0, 'flush_after_simulate': True, 'file_extension': 'dat', 'record_from': (<SLILiteral: rate>,), 'supports_precise_spikes': False, 'start': 0.0, 'withtime': True, 'offset': 0.0, 'withrport': False, 'local': True, 'thread_local_id': -1}, {'interval': 0.1, 'use_gid_in_filename': True, 'precision': 3, 'events': {'rate': array([], dtype=float64), 'times': array([], dtype=float64)}, 'local_id': 4, 'element_type': <SLILiteral: recorder>, 'to_accumulator': False, 'withtargetgid': False, 'close_after_simulate': False, 'to_file': False, 'flush_records': False, 'origin': 0.0, 'label': '', 'withport': False, 'withgid': False, 'global_id': 4, 'to_screen': False, 'time_in_steps': False, 'frozen': False, 'withweight': False, 'record_to': (<SLILiteral: memory>,), 'fbuffer_size': -1, 'close_on_reset': True, 'vp': 0, 'binary': False, 'thread': 0, 'scientific': False, 'to_memory': True, 'node_uses_wfr': False, 'stop': 1.7976931348623157e+308, 'n_events': 0, 'model': <SLILiteral: multimeter>, 'parent': 0, 'flush_after_simulate': True, 'file_extension': 'dat', 'record_from': (<SLILiteral: rate>,), 'supports_precise_spikes': False, 'start': 0.0, 'withtime': True, 'offset': 0.0, 'withrport': False, 'local': True, 'thread_local_id': -1})
